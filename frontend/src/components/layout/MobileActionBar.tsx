...
/**
 * Reusable fixed action bar for mobile detail/checkout-like screens. It sits
 ...
 *
 * No consumers yet: this is scaffolding for future detail/confirmation
 * pages. Pages that render this bar must add enough `padding-bottom`
 * (~154px: 64px tab bar + 70px action bar + spacing) to their scrollable
 * content so it isn't hidden behind it.
 */
